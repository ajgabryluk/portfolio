...
export default function Projects(){
    return(
        ...
        <ProjectPreview 
          ...
          <ProjectPreview 
                source={"/COD-Demo.mp4"} 
                classification={"03 - Game Development / Unity / Game AI / Game Design / User Testing"} 
                title={"Count Down of Death - Zombies"} 
                description={"Developed and designed a timed, PVE wave arena shooter where the player unlocks new guns and passive upgrades to fight zombies and other ghouls threatening the city."}
            />  
         <ProjectPreview 
                source={"/VRLifeSkillsPortfolio.mp4"} 
                classification={"04 - VR / Unity / Project Management / EdTech"} 
            ...
            <ProjectPreview 
                ...
                classification={"05 - AR / UX Research / Unity / Navigation"} 
            ...
            <ProjectPreview 
                ...
                classification={"06 - UX Research / UX Design / Generative AI"} 
            ...
            <ProjectPreview 
                ...
                classification={"07 - VR / UX Research / Unity / Spatial Memory"} 
            ...
            <ProjectPreview 
                ...
                classification={"08 - VR / UX Research / Unreal Engine 5 / EEG"} 
