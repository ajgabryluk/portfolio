...
const projects = [
    ...
    { source: "/EdTechFinalProject.mp4", classification: ["UX Research", "EdTech", "UX Design"], title: "Charge Blade Tutorial", description: "Created a figma prototype which teaches users how to play the Charge Blade in Monster Hunter: Wilds for my education technology class final project.", "more": true},
